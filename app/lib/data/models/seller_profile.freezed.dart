...
mixin _$SellerProfile {
 ...
 int get id;@JsonKey(name: 'shop_name') String get shopName; String get handle; String? get bio; SokoniCategory? get category; String? get whatsapp; double? get lat; double? get lng; String? get address; String? get region; String? get district; String get status;@JsonKey(name: 'rejection_reason') String? get rejectionReason;@JsonKey(name: 'verified_at') DateTime? get verifiedAt;@JsonKey(name: 'rating_avg') double get ratingAvg;@JsonKey(name: 'rating_count') int get ratingCount;@JsonKey(name: 'is_owner') bool get isOwner;@JsonKey(name: 'created_at') DateTime? get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,shopName,handle,bio,category,whatsapp,lat,lng,address,region,district,status,rejectionReason,verifiedAt,ratingAvg,ratingCount,isOwner,createdAt);

@override
String toString() {
  return 'SellerProfile(id: $id, shopName: $shopName, handle: $handle, bio: $bio, category: $category, whatsapp: $whatsapp, lat: $lat, lng: $lng, address: $address, region: $region, district: $district, status: $status, rejectionReason: $rejectionReason, verifiedAt: $verifiedAt, ratingAvg: $ratingAvg, ratingCount: $ratingCount, isOwner: $isOwner, createdAt: $createdAt)';
}
...
/// Create a copy of SellerProfile
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? shopName = null,Object? handle = null,Object? bio = freezed,Object? category = freezed,Object? whatsapp = freezed,Object? lat = freezed,Object? lng = freezed,Object? address = freezed,Object? region = freezed,Object? district = freezed,Object? status = null,Object? rejectionReason = freezed,Object? verifiedAt = freezed,Object? ratingAvg = null,Object? ratingCount = null,Object? isOwner = null,Object? createdAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'shop_name')  String shopName,  String handle,  String? bio,  SokoniCategory? category,  String? whatsapp,  double? lat,  double? lng,  String? address,  String? region,  String? district,  String status, @JsonKey(name: 'rejection_reason')  String? rejectionReason, @JsonKey(name: 'verified_at')  DateTime? verifiedAt, @JsonKey(name: 'rating_avg')  double ratingAvg, @JsonKey(name: 'rating_count')  int ratingCount, @JsonKey(name: 'is_owner')  bool isOwner, @JsonKey(name: 'created_at')  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SellerProfile() when $default != null:
return $default(_that.id,_that.shopName,_that.handle,_that.bio,_that.category,_that.whatsapp,_that.lat,_that.lng,_that.address,_that.region,_that.district,_that.status,_that.rejectionReason,_that.verifiedAt,_that.ratingAvg,_that.ratingCount,_that.isOwner,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'shop_name')  String shopName,  String handle,  String? bio,  SokoniCategory? category,  String? whatsapp,  double? lat,  double? lng,  String? address,  String? region,  String? district,  String status, @JsonKey(name: 'rejection_reason')  String? rejectionReason, @JsonKey(name: 'verified_at')  DateTime? verifiedAt, @JsonKey(name: 'rating_avg')  double ratingAvg, @JsonKey(name: 'rating_count')  int ratingCount, @JsonKey(name: 'is_owner')  bool isOwner, @JsonKey(name: 'created_at')  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _SellerProfile():
return $default(_that.id,_that.shopName,_that.handle,_that.bio,_that.category,_that.whatsapp,_that.lat,_that.lng,_that.address,_that.region,_that.district,_that.status,_that.rejectionReason,_that.verifiedAt,_that.ratingAvg,_that.ratingCount,_that.isOwner,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id, @JsonKey(name: 'shop_name')  String shopName,  String handle,  String? bio,  SokoniCategory? category,  String? whatsapp,  double? lat,  double? lng,  String? address,  String? region,  String? district,  String status, @JsonKey(name: 'rejection_reason')  String? rejectionReason, @JsonKey(name: 'verified_at')  DateTime? verifiedAt, @JsonKey(name: 'rating_avg')  double ratingAvg, @JsonKey(name: 'rating_count')  int ratingCount, @JsonKey(name: 'is_owner')  bool isOwner, @JsonKey(name: 'created_at')  DateTime? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _SellerProfile() when $default != null:
return $default(_that.id,_that.shopName,_that.handle,_that.bio,_that.category,_that.whatsapp,_that.lat,_that.lng,_that.address,_that.region,_that.district,_that.status,_that.rejectionReason,_that.verifiedAt,_that.ratingAvg,_that.ratingCount,_that.isOwner,_that.createdAt);case _:
  return null;
...
class _SellerProfile implements SellerProfile {
  const _SellerProfile({required this.id, @JsonKey(name: 'shop_name') required this.shopName, required this.handle, this.bio, this.category, this.whatsapp, this.lat, this.lng, this.address, this.region, this.district, this.status = 'pending', @JsonKey(name: 'rejection_reason') this.rejectionReason, @JsonKey(name: 'verified_at') this.verifiedAt, @JsonKey(name: 'rating_avg') this.ratingAvg = 0, @JsonKey(name: 'rating_count') this.ratingCount = 0, @JsonKey(name: 'is_owner') this.isOwner = false, @JsonKey(name: 'created_at') this.createdAt});
...
/// Create a copy of SellerProfile
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? shopName = null,Object? handle = null,Object? bio = freezed,Object? category = freezed,Object? whatsapp = freezed,Object? lat = freezed,Object? lng = freezed,Object? address = freezed,Object? region = freezed,Object? district = freezed,Object? status = null,Object? rejectionReason = freezed,Object? verifiedAt = freezed,Object? ratingAvg = null,Object? ratingCount = null,Object? isOwner = null,Object? createdAt = freezed,}) {
