...
@if (app()->getLocale() === 'sw')
    ...
    <div class="prose prose-sm mt-24 max-w-none space-y-16 text-sokoni-black/80">
        ...
        <p>Kila muuzaji kwenye Sokoni hupitia uthibitisho wa kibinafsi kabla bidhaa zake hazijaonekana hadharani — namba ya NIDA na picha ya kitambulisho hukaguliwa na timu yetu, sio kanuni ya kompyuta pekee. Leseni ya biashara inaweza kuongezwa pia, lakini si lazima; NIDA ndicho msingi halisi wa uthibitisho. Hii ndiyo ulinzi wetu mkuu dhidi ya maduka ya udanganyifu.</p>
...
@else
    ...
    <div class="prose prose-sm mt-24 max-w-none space-y-16 text-sokoni-black/80">
        ...
        <p>Every seller on Sokoni goes through manual identity verification before their products go live — a NIDA number and ID photo, reviewed by our team, not just a form. A business licence can be added too, but it's optional; NIDA is what verification is actually based on. That's our main defence against fraudulent shops, and the reason a verified badge here actually means something.</p>
